        ...
        <div class="box-body">
          <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/blog_category/add')?>" role="form" novalidate>
            ...
            <div class="row m-t-30">
              <div class="col-sm-12">
                <?php if (isset($page_title) && $page_title == "Edit"): ?>
                  <button type="submit" class="btn btn-info rounded pull-left">Save Changes</button>
                <?php else: ?>
                  <button type="submit" class="btn btn-info rounded pull-left"> Save Category</button>
                <?php endif; ?>
              </div>
            </div>
          </form>
