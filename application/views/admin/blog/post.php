<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="col-md-6 m-auto box add_area mt-50" style="display: <?php if($page_title == "Edit"){echo "block";}else{echo "none";} ?>">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit"): ?>
            <a href="<?php echo base_url('admin/blog') ?>" class="pull-right btn btn-default btn-sm"><i class="fa fa-angle-left"></i> Back</a>
          <?php else: ?>
    ...
    <div class="list_area container">
        ...
        <?php else: ?>
          <h3 class="box-title">All Blog posts <a href="#" class="pull-right btn btn-info btn-sm add_btn"><i class="fa fa-plus"></i> Add new blog</a></h3>
        <?php endif; ?>
