          ...
          <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive mt-20 p-0">
            <div class="col-md-12 col-sm-12 col-xs-12 scroll">
                <table class="table table-bordered table-hover table-stripe">
                    <tbody>
                        <tr>
                            <td width="30%"><h2>Manage Packages</h2></td>
                            <?php $i=1; foreach ($packages as $package): ?>
                              <td class="text-center">
                                <h2 class="mt-10"><?php echo html_escape($package->name); ?> </h2>
                                <h3 class="mb-15"><?php echo currency_to_symbol(settings()->currency); ?><?php echo round($package->price); ?>  <span class="fs-14">per year</span> | <?php echo currency_to_symbol(settings()->currency); ?><?php echo round($package->monthly_price); ?>  <span class="fs-14"> per month</h3>

                                <a href="#packageModal_<?php echo html_escape($package->id);?>" data-toggle="modal" class="btn btn-default" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> Edit Package</a>
                              </td>
                            <?php $i++; endforeach; ?>
                            <td></td>
                        </tr>
                        ...
                        <?php foreach ($features as $feature): ?>
                          <tr>
                              ...
                              <td width="5%"><a href="#featureModal_<?php echo html_escape($feature->id);?>" data-toggle="modal" class="btn btn-default" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> Edit Features</a></td>
                          </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
        ...
        <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/package/update_features/'.$feature->id)?>" role="form" novalidate>
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Update Package features for - <?php echo html_escape($feature->name) ?></h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs admin">
                      <li><a class="active monthly_btn">Monthly</a></li>
                      <li><a class="yearly_btn">Yearly</a></li>
                    </ul>
                    ...
                    <div class="mt-20"><hr>
                      ...
                      <div class="monthly_area">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Basic Limit</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="basic">
                                    <option value="">----</option>
                                    <option <?php if($feature->basic == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->basic == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->basic == 2){echo "selected";} ?> value="2">Unlimited</option>
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Standared Limit</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="standared">
                                    <option value="">----</option>
                                    <option <?php if($feature->standared == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->standared == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->standared == 2){echo "selected";} ?> value="2">Unlimited</option>
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Premium Limit</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="premium">
                                    <option value="">----</option>
                                    <option <?php if($feature->premium == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->premium == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->premium == 2){echo "selected";} ?> value="2">Unlimited</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="year_basic">
                                    <option value="">----</option>
                                    <option <?php if($feature->year_basic == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->year_basic == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->year_basic == 2){echo "selected";} ?> value="2">Unlimited</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="year_standared">
                                    <option value="">----</option>
                                    <option <?php if($feature->year_standared == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->year_standared == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->year_standared == 2){echo "selected";} ?> value="2">Unlimited</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="year_premium">
                                    <option value="">----</option>
                                    <option <?php if($feature->year_premium == 0){echo "selected";} ?> value="0">No</option>
                                    <option <?php if($feature->year_premium == 1){echo "selected";} ?> value="1">Yes</option>
                                    <option <?php if($feature->year_premium == 2){echo "selected";} ?> value="2">Unlimited</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info waves-effect pull-right">Save changes</button>
                </div>
            </div>
        </form>
        <!-- /.modal-content -->
...
<div id="packageModal_<?php echo html_escape($package->id) ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-zoom modal-md">
        <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/package/update/'.$package->id)?>" role="form" novalidate>
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Update Package - <?php echo html_escape($package->name) ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                   
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Monthly Price</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-4 text-right control-label col-form-label">Yearly Price</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row mt-20">
                        ...
                        <div class="col-sm-8">
                          ...
                          <label for="md_checkbox_3">Is Popular Package?</label>
                        </div>
                    </div>
