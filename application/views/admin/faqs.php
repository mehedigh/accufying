<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="list_area container">
      ...
      <?php if (isset($page_title) && $page_title == "Edit"): ?>
        <h3 class="box-title">Edit faq <a href="<?php echo base_url('admin/pages') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> Back</a></h3>
      <?php else: ?>
        <h3 class="box-title">All Faqs <a href="#" class="pull-right btn btn-info btn-sm add_btn"><i class="fa fa-plus"></i> Add new faq</a></h3>
      <?php endif; ?>
