<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="col-md-6 m-auto box add_area" style="display: <?php if($page_title == "Edit"){echo "block";}else{echo "none";} ?>">
      ...
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <?php if (isset($page_title) && $page_title == "Edit"): ?>
            <a href="<?php echo base_url('admin/product') ?>" class="pull-right btn btn-default rounded btn-sm"><i class="fa fa-angle-left"></i> Back</a>
          <?php else: ?>
      ...
      <div class="box-body">
        <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/product/add')?>" role="form" novalidate>
          ...
          <div class="form-group">
              ...
              <label for="md_checkbox_1"> Sell this</label>
          ...
          <div class="form-group m-t-30">
              ...
              <label for="md_checkbox_2"> Buy this</label>
          ...
          <div class="form-group col-md-6 p-0 expense_list" style="display: <?php if($product[0]['is_buy'] == 1){echo "block";}else{echo "none";} ?>;">
              <label class="col-sm-12 control-label p-0" for="example-input-normal">Expense Category </label>
          ...
          <div class="row m-t-30">
            <div class="col-sm-12">
              ...
              <?php else: ?>
                <button type="submit" class="btn btn-info rounded pull-left"><i class="fa fa-check"></i> Save Product</button>
              <?php endif; ?>
            </div>
          </div>
    ...
    <div class="list_area container">
        ...
        <?php if (isset($page_title) && $page_title == "Edit"): ?>
          <h3 class="box-title">Edit product <a href="<?php echo base_url('admin/product') ?>" class="pull-right btn btn-primary btn-sm"><i class="fa fa-angle-left"></i> Back</a></h3>
        <?php else: ?>
          <h3 class="box-title">Products & Services <a href="#" class="pull-right btn btn-info btn-sm add_btn rounded"><i class="fa fa-plus"></i> Add new product</a></h3>
        <?php endif; ?>
