        ...
        <form id="send-invoice-form" method="post" class="validate-form send-invoice-form" action="<?php echo base_url('admin/invoice/send')?>" role="form" novalidate>
            <div class="modal-content modal-md">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Send Invoice</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">

                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Invoice To</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Subject</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 text-right control-label col-form-label">Message</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row mt-10">
                        ...
                        <div class="col-sm-9">
                            ...
                            <label for="md_checkbox_22"> Send a copy to myself at <b><?php echo user()->email ?></b></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="submit_btn btn btn-info rounded waves-effect pull-right">Send</button>
                    <button type="button" class="btn btn-default rounded waves-effect pull-right" data-dismiss="modal" aria-hidden="true">Close</button>
                </div>
            </div>
        </form>
        <!-- /.modal-content -->
