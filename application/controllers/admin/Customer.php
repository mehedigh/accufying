...
class Customer extends Home_Controller {
        ...
        {   
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($id != '') {
                    ...
                    $this->session->set_flashdata('msg', 'Customer Edited Successfully'); 
                } else {
    ...
    public function active($id) 
    {
        ...
        $this->session->set_flashdata('msg', 'customers activate Successfully'); 
        redirect(base_url('admin/customers'));
    }
    ...
    public function deactive($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->admin_model->update($data, $id,'customers');
        $this->session->set_flashdata('msg', 'customers deactivate Successfully'); 
        redirect(base_url('admin/customers'));
    }
