...
class Vendor extends Home_Controller {
        ...
        {   
            ...
            if ($this->form_validation->run() === false) {
                ...
                if ($id != '') {
                    ...
                    $this->session->set_flashdata('msg', 'Vendor Edited Successfully'); 
                } else {
    ...
    public function active($id) 
    {
        ...
        $this->session->set_flashdata('msg', 'Vendor activate Successfully'); 
        redirect(base_url('admin/vendor'));
    }
    ...
    public function deactive($id) 
    {
        ...
        $data = $this->security->xss_clean($data);
        $this->admin_model->update($data, $id,'vendors');
        $this->session->set_flashdata('msg', 'Vendor deactivate Successfully'); 
        redirect(base_url('admin/Vendor'));
    }
